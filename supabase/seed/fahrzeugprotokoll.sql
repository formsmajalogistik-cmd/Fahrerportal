...
-- ------------------------------------------------------------
-- Im Supabase SQL Editor ausführen, um das Template anzulegen.
-- Das identische Schema wird auch vom Admin-Button
-- "Fahrzeugprotokoll anlegen" (TemplatesListPage) erzeugt —
    ...
    "sections": [
      ...
      },
      {
        ...
        "fields": [
          ...
          { "id": "uebernahme_gegebenheiten", "type": "checkboxes", "label": "Gegebenheiten",
            "options": ["Dunkelheit", "Regen", "Schnee/Eis", "Außen verschmutzt", "Innen verschmutzt"] },
          { "id": "uebernahme_tank", "type": "select", "label": "Tank/Akku",
            "options": ["0/4", "1/4", "1/2", "3/4", "4/4"] },
      ...
      },
      {
        ...
        "fields": [
          ...
          { "id": "uebergabe_tank",       "type": "select",   "label": "Tank/Akku",
            "options": ["0/4", "1/4", "1/2", "3/4", "4/4"] },
      ...
      },
      {
        ...
        "fields": [
          { "id": "zubehoer_liste", "type": "checkboxes", "label": "Zubehör",
            "options": [
      ...
      },
      {
        ...
        "title": "Schäden Innen",
        "fields": [
          { "id": "zustand_innen", "type": "checkboxes", "label": "Zustand",
      ...
      },
      {
        ...
        "title": "Reifen",
        "fields": [
          { "id": "reifentyp", "type": "checkboxes", "label": "Reifentyp",
