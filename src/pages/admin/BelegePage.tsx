...
import { heicToJpeg } from './belege/heic';
import { ImageCropDialog } from './belege/ImageCropDialog';
import { downloadBlob, generateBelegePdf, type Layout } from './belege/belegPdf';
...
export function BelegePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-maja-navy">Beleg-PDF erstellen</h1>
